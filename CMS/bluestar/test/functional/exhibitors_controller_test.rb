...
class ExhibitorsControllerTest < ActionController::TestCase
  ...
  test "should create exhibitor" do
    assert_difference('Exhibitor.count') do
      post :create, exhibitor: { filename: @exhibitor.filename, name: @exhibitor.name, pdf: @exhibitor.pdf, type: @exhibitor.type }
    end
  ...
  test "should update exhibitor" do
    put :update, id: @exhibitor, exhibitor: { filename: @exhibitor.filename, name: @exhibitor.name, pdf: @exhibitor.pdf, type: @exhibitor.type }
    assert_redirected_to exhibitor_path(assigns(:exhibitor))
  end
