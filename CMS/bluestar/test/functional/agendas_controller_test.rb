...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { filename: @agenda.filename, name: @agenda.name, pdf: @agenda.pdf, type: @agenda.type }
    end
  ...
  test "should update agenda" do
    put :update, id: @agenda, agenda: { filename: @agenda.filename, name: @agenda.name, pdf: @agenda.pdf, type: @agenda.type }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
