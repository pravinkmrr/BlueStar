...
class CalendarsControllerTest < ActionController::TestCase
  ...
  test "should create calendar" do
    assert_difference('Calendar.count') do
      post :create, calendar: { date: @calendar.date, event: @calendar.event, message: @calendar.message, time: @calendar.time, title: @calendar.title }
    end
  ...
  test "should update calendar" do
    put :update, id: @calendar, calendar: { date: @calendar.date, event: @calendar.event, message: @calendar.message, time: @calendar.time, title: @calendar.title }
    assert_redirected_to calendar_path(assigns(:calendar))
  end
