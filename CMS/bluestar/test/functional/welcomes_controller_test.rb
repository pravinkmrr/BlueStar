...
class WelcomesControllerTest < ActionController::TestCase
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post :create, welcome: { filename: @welcome.filename, name: @welcome.name, pdf: @welcome.pdf, type: @welcome.type }
    end
  ...
  test "should update welcome" do
    put :update, id: @welcome, welcome: { filename: @welcome.filename, name: @welcome.name, pdf: @welcome.pdf, type: @welcome.type }
    assert_redirected_to welcome_path(assigns(:welcome))
  end
